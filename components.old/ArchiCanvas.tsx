...
// Esta é uma matriz de validação conceitual simplificada, movida para o frontend.
 ...
 */
const getValidRelationshipType = (sourceType: ArchiElementType, targetType: ArchiElementType): ArchiRelationshipType | null => {
